"""
Django settings for yamboWebDev project.
...
WSGI_APPLICATION = 'yamboWebDev.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / "static/media/fotos_monitores/",
]
